    ...
    <header className='text-white'>
        ...
        <div className="container mx-auto p-1 md:pb-[30px] lg:pb-[30px] md:pt-4 lg:pt-4 lg:flex justify-between nav ">
         <Link href="/">
            ...
            <div className='flex'>
            <input className='bg-white text-black w-[425px] rounded md:rounded-none lg:rounded-none md:w-[300px] lg:w-[550px] mx-auto px-3 border-rounded h-[45px] outline-0 ' type="text" placeholder='Search in Daraz'/>
